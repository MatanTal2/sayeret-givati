...
import { Users, Shield, ArrowRightLeft, Settings, Database, UserCheck, Mail, Layers, Package, Zap, Archive, BellRing, Crosshair, KeyRound, Tags, Boxes } from 'lucide-react';
...
const ALL_MANAGEMENT_TABS: ManagementTab[] = [
  ...
  {
    id: 'categories',
    label: MANAGEMENT.TABS.CATEGORIES,
    icon: Tags,
    description: MANAGEMENT.TAB_DESCRIPTIONS.CATEGORIES,
    category: 'equipment'
  },
  {
