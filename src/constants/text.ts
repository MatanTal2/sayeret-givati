...
על ידי הסכמתך, אתה מאשר כי קראת והבנת את התנאים לעיל.`,
  ...
  FEATURES: {
    ...
    EQUIPMENT: {
      ...
      STATUS_EXCHANGE_REQUESTED: 'החלפה - ממתין לאישור',
      STATUS_STORED: 'מאוחסן',
      STATUS_RETIRED: 'הוחזר לצבא',
      ...
      ROW_ACTIONS: {
        ...
        HISTORY: 'היסטוריה',
        MORE: 'עוד פעולות',
        REQUEST_EXCHANGE: 'בקש החלפה',
        APPROVE_EXCHANGE: 'אשר החלפה',
        REJECT_EXCHANGE: 'דחה החלפה',
        REPLACE_BY_ANOTHER: 'החלף בפריט אחר',
        SEND_TO_STORAGE: 'שלח לאחסון',
        PULL_FROM_STORAGE: 'הוצא מאחסון',
      },
      EXCHANGE: {
        REQUEST_TITLE: 'בקשת החלפה',
        REQUEST_DESCRIPTION: 'תאר את הסיבה להחלפה. הצולם יתבקש לאשר ולציין מספר סידורי חדש.',
        APPROVE_TITLE: 'אישור החלפה',
        APPROVE_DESCRIPTION: 'הזן מספר סידורי של הפריט החדש שיוקצה למחזיק.',
        REPLACE_TITLE: 'החלפה בפריט אחר',
        REPLACE_DESCRIPTION: 'החלף את הפריט במספר סידורי חדש. הפריט הישן יוחזר לצבא.',
        REJECT_TITLE: 'דחיית בקשת החלפה',
        REJECT_DESCRIPTION: 'הזן סיבה לדחיית הבקשה.',
        REASON_LABEL: 'סיבה',
        REASON_PLACEHOLDER: 'הזן סיבה...',
        NEW_SERIAL_LABEL: 'מספר סידורי חדש',
        NEW_SERIAL_PLACEHOLDER: 'הזן מספר סידורי...',
        SUBMIT_REQUEST: 'שלח בקשה',
        SUBMIT_APPROVE: 'אשר ושייך מספר סידורי',
        SUBMIT_REJECT: 'דחה בקשה',
        SUBMIT_REPLACE: 'בצע החלפה',
        CANCEL: 'ביטול',
        REQUEST_SUCCESS: 'בקשת ההחלפה נשלחה',
        APPROVE_SUCCESS: 'ההחלפה אושרה והפריט החדש נוצר',
        REJECT_SUCCESS: 'הבקשה נדחתה',
        REPLACE_SUCCESS: 'הפריט הוחלף בהצלחה',
        VALIDATION_REASON_REQUIRED: 'יש להזין סיבה',
        VALIDATION_SERIAL_REQUIRED: 'יש להזין מספר סידורי',
        VALIDATION_SERIAL_TAKEN: 'מספר סידורי זה כבר קיים במערכת',
        PREDECESSOR_PILL: 'נוצר מהחלפת {serial}',
      },
      STORAGE: {
        SEND_TITLE: 'שליחה לאחסון',
        SEND_DESCRIPTION: 'הפריט יסומן כמאוחסן ויוחרג מבדיקות יומיות. לא ניתן להעבירו בזמן האחסון.',
        SEND_SUBMIT: 'שלח לאחסון',
        SEND_SUCCESS: 'הפריט נשלח לאחסון',
        PULL_TITLE: 'הוצאה מאחסון',
        PULL_DESCRIPTION: 'הפריט יחזור לסטטוס זמין.',
      ...
      SYSTEM_CONFIG: {
        ...
        ROUND_OPEN_HELP: 'כאשר מופעל, משתמשים יכולים להוציא פריטים מאחסון. כבה בסוף הסבב.',
      },
      ...
      HISTORY_PANEL: {
        ...
        EXPAND_ROW_ARIA: 'הצג פרטים נוספים',
      ...
      ACTION_TYPES: {
        transfer_requested: 'בקשת העברה',
        transfer_approved: 'אישור העברה',
        transfer_rejected: 'דחיית העברה',
        force_transfer_holder: 'העברה כפויה (מחזיק)',
        force_transfer_signer: 'העברה כפויה (חותם)',
        retirement_requested: 'בקשת החזרה לצבא',
        retirement_approved: 'אישור החזרה לצבא',
        retirement_rejected: 'דחיית החזרה לצבא',
        exchange_requested: 'בקשת החלפה',
        exchange_approved: 'אישור החלפה',
        exchange_rejected: 'דחיית החלפה',
        exchange_completed: 'החלפה הושלמה',
        stored: 'נשלח לאחסון',
        reissued: 'הוצא מאחסון',
        report_submitted: 'דווח',
        report_requested: 'בקשת דיווח',
        maintenance_start: 'תחילת תחזוקה',
        maintenance_complete: 'סיום תחזוקה',
        status_update: 'עדכון סטטוס',
        condition_update: 'עדכון מצב',
        equipment_created: 'פריט נוצר',
        equipment_retired: 'פריט הוחזר לצבא',
        template_proposed: 'תבנית הוצעה',
        template_requested: 'בקשת תבנית',
        template_approved: 'אישור תבנית',
        template_rejected: 'דחיית תבנית',
        template_updated: 'עדכון תבנית',
        template_retired: 'תבנית הוצאה משירות',
        ammo_assigned_from_central: 'תחמושת הוקצתה ממחסן מרכזי',
        ammo_returned_to_central: 'תחמושת הוחזרה למחסן מרכזי',
        ammo_central_bulk_load: 'טעינה מרובה למחסן מרכזי',
        sign_in: 'חתימה',
        sign_out: 'חתימה חזרה',
        location_update: 'עדכון מיקום',
        notes_update: 'עדכון הערות',
      },
      CONDITION_LABELS: {
        good: 'תקין',
        needs_repair: 'דורש תיקון',
      ...
      WIZARD: {
        ...
        TEAM_LABEL_CHECKBOX: 'הפריט עבור צוות?',
        TEAM_LABEL_HINT: 'תיוג בלבד — האחריות נשארת על החותם, להעברה השתמש ב"העברה".',
        TEAM_LABEL_PLACEHOLDER: 'בחר צוות',
      ...
      REPORT_REQUEST: {
        ...
        TARGET_TEAM_LABEL: 'צוות יעד',
        TARGET_TEAM_PLACEHOLDER: 'בחר צוות',
    ...
    ADMIN: {
      PERSONNEL: {
        TAB_LABEL: 'כוח אדם',
        SEARCH_PLACEHOLDER: 'חפש לפי שם או טלפון',
        FILTER_TOGGLE_ARIA: 'הצג/הסתר מסננים',
        FILTERS_ACTIVE_DOT_ARIA: 'מסננים פעילים',
        CLEAR_FILTERS: 'נקה',
        FILTER_RANK_LABEL: 'דרגה',
        FILTER_RANK_PLACEHOLDER: 'כל הדרגות',
        FILTER_USER_TYPE_LABEL: 'סוג משתמש',
        FILTER_USER_TYPE_PLACEHOLDER: 'כל הסוגים',
        FILTER_REGISTRATION_LABEL: 'סטטוס רישום',
        REG_ALL: 'הכול',
        REG_REGISTERED: 'רשומים',
        REG_PENDING: 'ממתינים',
        SORT_LABEL: 'מיון',
        SORT_OPTIONS: {
          CREATED_DESC: 'תאריך (חדש → ישן)',
          CREATED_ASC: 'תאריך (ישן → חדש)',
          NAME_ASC: 'שם (א → ת)',
          NAME_DESC: 'שם (ת → א)',
          RANK_DESC: 'דרגה (גבוהה → נמוכה)',
          RANK_ASC: 'דרגה (נמוכה → גבוהה)'
        },
        EDIT: 'ערוך',
        DELETE: 'מחק',
        SAVE: 'שמור',
        CANCEL: 'ביטול',
        SAVING: 'שומר...',
        EXPAND_ARIA: 'הרחב פרטים',
        COLLAPSE_ARIA: 'צמצם פרטים',
        ACTIONS_MORE_ARIA: 'פעולות נוספות',
        REGISTERED_BADGE: 'רשום',
        PENDING_BADGE: 'ממתין',
        REGISTRATION_DOT_ARIA: 'סטטוס רישום',
        FIELD_FIRST_NAME: 'שם פרטי',
        FIELD_LAST_NAME: 'שם משפחה',
        FIELD_RANK: 'דרגה',
        FIELD_PHONE: 'מספר טלפון',
        FIELD_USER_TYPE: 'סוג משתמש',
        FIELD_REGISTRATION: 'סטטוס רישום',
        FIELD_CREATED_AT: 'תאריך הוספה',
        TOTAL: 'סה״כ',
        FILTERED: 'מסונן',
        EMPTY_NO_PERSONNEL: 'לא נמצא כוח אדם מורשה. הוסף כוח אדם תחילה.',
        EMPTY_NO_RESULTS: 'לא נמצאו תוצאות התואמות לחיפוש.',
        LOADING: 'טוען כוח אדם...',
        DELETE_CONFIRM_TITLE: 'אישור מחיקה',
        DELETE_CONFIRM_MESSAGE: 'האם להסיר את {name} מרשימת הכוח אדם המורשה?',
        DELETE_CONFIRM_BTN: '🗑️ הסר',
        DELETE_CONFIRM_CANCEL: 'ביטול',
        DELETE_CONFIRM_WARNING: '⚠️ אזהרה: פעולה זו אינה ניתנת לשחזור.',
        NO_CHANGES: 'לא בוצעו שינויים',
        UPDATE_FAILED: 'עדכון נכשל. נסה שוב.',
        VALIDATION_NAME: 'השם חייב להכיל רק אותיות עבריות, רווחים, מקפים (-) או גרש (\').',
        VALIDATION_RANK: 'יש לבחור דרגה.',
        VALIDATION_PHONE: 'מספר טלפון לא תקין.'
      }
    }
  },
  ...
  MANAGEMENT: {
    ...
    TABS: {
      ...
      LOGISTICS_TEMPLATES: 'תבניות אפסנאות',
    ...
    TAB_DESCRIPTIONS: {
      ...
      LOGISTICS_TEMPLATES: 'ניהול קטלוג הציוד הלא-ממוספר (אפסנאות) — שמות, קטגוריות, השבתה',
