  ...
  return (
    <>
      ...
      <div className="text-center px-6 pb-4">
        <div className="w-12 h-12 bg-gradient-to-br from-info-400 to-info-600 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <h3 className="text-xl font-bold text-neutral-900 mb-2">פרטים אישיים</h3>
        <p className="text-base text-neutral-600 mb-6">השלם את הפרטים האישיים שלך</p>
      </div>
        ...
        <form className="space-y-3">
          ...
          <div className="space-y-1">
            <input
              ...
              placeholder={TEXT_CONSTANTS.REGISTRATION_COMPONENTS.ENTER_FIRST_NAME}
              data-testid="first-name-input"
            />
            
            {/* First Name Error Message */}
            {validationErrors.firstName && formData.firstName && (
              <p className="text-xs text-danger-600 text-right px-1" data-testid="first-name-error">
          ...
          <div className="space-y-1">
            <input
              ...
              placeholder={TEXT_CONSTANTS.REGISTRATION_COMPONENTS.ENTER_LAST_NAME}
              data-testid="last-name-input"
            />
            
            {/* Last Name Error Message */}
            {validationErrors.lastName && formData.lastName && (
              <p className="text-xs text-danger-600 text-right px-1" data-testid="last-name-error">
