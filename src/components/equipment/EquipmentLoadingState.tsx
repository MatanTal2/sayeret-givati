        ...
        {Array.from({ length: count }).map((_, index) => (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="h-5 bg-neutral-300 dark:bg-neutral-600 rounded w-16"></div>
                </div>
                <div className="h-6 bg-neutral-300 dark:bg-neutral-600 rounded w-32 mb-1"></div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="h-4 bg-neutral-300 dark:bg-neutral-600 rounded w-28"></div>
                </div>
                <div>
                  <div className="h-3 bg-neutral-200 dark:bg-neutral-700 rounded w-20 mb-1"></div>
            ...
            <div className="flex gap-2 mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-700">
              <div className="flex-1 h-8 bg-neutral-300 dark:bg-neutral-600 rounded"></div>
              <div className="flex-1 h-8 bg-neutral-300 dark:bg-neutral-600 rounded"></div>
              <div className="w-10 h-8 bg-neutral-300 dark:bg-neutral-600 rounded"></div>
            </div>
          </div>
        ))}
      </div>
